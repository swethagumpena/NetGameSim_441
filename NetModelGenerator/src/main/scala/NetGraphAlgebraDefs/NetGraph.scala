...
import java.io.{BufferedReader, BufferedWriter, ByteArrayInputStream, File, FileInputStream, FileReader, FileWriter, InputStream, ObjectInputStream}
...
object NetGraph:
   ...
   def load(filePath: String): Option[NetGraph] = {
